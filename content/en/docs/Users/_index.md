...
5. Optionally, include additional information about the Proxy/sponsor relationship:
    ...
    -  **Notifications sent to**. Select whether **Proxy** or **Sponsor** should receive notifications from the library. (Note: functionality to send notifications to the proxy is pending UXPROD-3937).
