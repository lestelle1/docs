...
The exported CSV file can be retrieved from the Export Manager app.
...
To run the transfer now without saving, click the "Run manually" button. The exported CSV file can be retrieved from the Export Manager app.
